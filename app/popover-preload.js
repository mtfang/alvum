...
contextBridge.exposeInMainWorld('alvum', {
  ...
  cancelBriefingDate: (date) => ipcRenderer.invoke('alvum:cancel-briefing-date', date),
  ...
  synthesisSchedule: () => ipcRenderer.invoke('alvum:synthesis-schedule'),
  synthesisScheduleSave: (patch) => ipcRenderer.invoke('alvum:synthesis-schedule-save', patch),
  synthesisScheduleRunDue: () => ipcRenderer.invoke('alvum:synthesis-schedule-run-due'),
  ...
  installWhisperModel: (variant)     => ipcRenderer.invoke('alvum:install-whisper-model', variant),
  installPyannote:   ()             => ipcRenderer.invoke('alvum:install-pyannote'),
  openPyannoteTerms: ()             => ipcRenderer.invoke('alvum:open-pyannote-terms'),
  ...
  speakerList:        ()            => ipcRenderer.invoke('alvum:speaker-list'),
  speakerSamples:     ()            => ipcRenderer.invoke('alvum:speaker-samples'),
  speakerLink:        (id, interestId) => ipcRenderer.invoke('alvum:speaker-link', id, interestId),
  ...
  speakerUnlinkInterest: (interestId) => ipcRenderer.invoke('alvum:speaker-unlink-interest', interestId),
  speakerRename:      (id, label)   => ipcRenderer.invoke('alvum:speaker-rename', id, label),
  speakerMerge:       (sourceId, targetId) => ipcRenderer.invoke('alvum:speaker-merge', sourceId, targetId),
  speakerForget:      (id)          => ipcRenderer.invoke('alvum:speaker-forget', id),
  speakerReset:       ()            => ipcRenderer.invoke('alvum:speaker-reset'),
  speakerSampleAudio: (id, sampleIndex) => ipcRenderer.invoke('alvum:speaker-sample-audio', id, sampleIndex),
  voiceSampleAudio:   (sampleId)    => ipcRenderer.invoke('alvum:voice-sample-audio', sampleId),
