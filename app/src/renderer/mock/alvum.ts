...
export function installMockAlvum(DEFAULT_DAILY_BRIEFING_OUTLINE) {
    ...
    const state = {
      ...
      updateState: {
        ...
        currentVersion: scenario === 'update' ? '0.1.10' : '0.1.11',
        latestVersion: '0.1.11',
        releaseName: scenario === 'update' ? 'Alvum 0.1.11' : null,
        releaseDate: '2026-05-01T04:00:00.000Z',
        releaseUrl: 'https://github.com/mtfang/alvum/releases/tag/0.1.11',
        error: null,
        progress: null,
