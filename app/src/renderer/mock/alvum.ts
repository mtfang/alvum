...
export function installMockAlvum(DEFAULT_DAILY_BRIEFING_OUTLINE) {
    ...
    const state = {
      ...
      updateState: {
        ...
        currentVersion: scenario === 'update' ? '0.1.11' : '0.1.12',
        latestVersion: '0.1.12',
        releaseName: scenario === 'update' ? 'Alvum 0.1.12' : null,
        releaseDate: '2026-05-01T05:30:00.000Z',
        releaseUrl: 'https://github.com/mtfang/alvum/releases/tag/0.1.12',
        error: null,
        progress: null,
