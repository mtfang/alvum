...
export function installMockAlvum(DEFAULT_DAILY_BRIEFING_OUTLINE) {
    ...
    const state = {
      ...
      updateState: {
        ...
        currentVersion: scenario === 'update' ? '0.1.12' : '0.1.13',
        latestVersion: '0.1.13',
        releaseName: scenario === 'update' ? 'Alvum 0.1.13' : null,
        releaseDate: '2026-05-01T06:01:23.000Z',
        releaseUrl: 'https://github.com/mtfang/alvum/releases/tag/0.1.13',
        error: null,
        progress: null,
    ...
    const mockProgress = [
      ...
      { stage: 'distill', current: 1, total: 2 },
    ];
    const mockEvents = [
